...
/* 引脚定义 */
#define ATK_MW579_STA_GPIO_PORT             GPIOC
#define ATK_MW579_STA_GPIO_PIN              GPIO_PIN_4
#define ATK_MW579_STA_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)
#define ATK_MW579_WKUP_GPIO_PORT            GPIOA
#define ATK_MW579_WKUP_GPIO_PIN             GPIO_PIN_4
#define ATK_MW579_WKUP_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)
